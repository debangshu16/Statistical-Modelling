...
#There seems to be significant lags in the model residuals. We now perform the 
#statistical tests Ljung Box and Box Pierce tests to check for autocorrelation
